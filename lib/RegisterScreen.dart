            ...
            child: Column(
              children: [
                ...
                Form(child: Column(
                  key: _key,
                  children: [
                    custom_field(label: "Enter Your FullName", controller: _name, prefixicon: Icon(FontAwesomeIcons.user,size: 18,), surfixneed: true),
                    SizedBox(height: 15,),
                    custom_field(label: "Enter Your Age", controller: _age, prefixicon: Icon(FontAwesomeIcons.hashtag,size: 18), surfixneed: true),
                    SizedBox(height: 15,),
                    custom_field(label: "Enter Your Gender", controller: _gender, prefixicon: Icon(FontAwesomeIcons.venusMars,size: 18), surfixneed: true),
                    SizedBox(height: 15,),
                    ...
                    custom_field(label: "Enter Your Password",controller: _pass,Errormsg:  "Password is Required", prefixicon: Icon(FontAwesomeIcons.lock,size: 18), surfixneed: true,surfixIcon: IconButton(onPressed: (){setState(() {
                      ischeck = !ischeck;
                    });},icon: ischeck==false?Icon(Icons.visibility,size: 18):Icon(Icons.visibility_off,size: 18)),ispassword: ischeck==false?false:true,),
